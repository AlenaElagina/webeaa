...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center" style="font-family: 'Lobster', cursive;">
    ...
    <h3 class="display-6" style="color:#0000FF">Брошки </h3>
</div>
...
<div class="container">
    <div class="row justify-content-evenly">
        <div class="col-3">
            <form action="">
                <button class="btn btn-outline-primary" id="close-image"><img src="../assets/images/.jpg" class="rounded float-left" width="250" height="250"></button>
            </form>
        </div>
